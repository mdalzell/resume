...
\begin{paracol}{2}
    ...
    % Bread
    \textbf{Bread Financial} - Columbus, OH (Remote) \\
    ...
    \begin{itemize}
        ...
        \item Lead React application development for a new direct-to-consumer lending product.
        ...
        \item Designed and implemented the REST API interface for a Go microservice that handles loan payments and autopay enrollment.
        \item Established a cross-team frontend guild to share knowledge among engineers across the organization.
        \item Coordinated an effort to improve Bread's engineer interview experience by creating new questions to assess a candidate's frontend coding and system design ability in a fair and unbiased manner.
        \item Worked with enterprise architects to develop a set of recommended patterns, frameworks, and tools for frontend development.
